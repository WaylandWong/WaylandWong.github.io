...
![OAuth Application](/images/drone/4.png)
...
* 通过浏览器访问：<http://127.0.0.1> ，浏览器会重定向到github登陆认证页面![auth](../images/drone/7.png)
使用github账户登陆之后，浏览器被重定向回drone，并被授权访问你的github仓库![drone](/images/drone/8.png)
